...
import com.davidlong.http.annotation.Parameter;
import com.davidlong.http.annotation.Parameters;
import com.davidlong.http.annotation.control.FailedRetry;
import com.davidlong.http.annotation.control.FailedTerminate;
...
public class TestMulti {
    ...
    public class OrderChain {
        ...
        public boolean chainBeforeHandler(FormParamStore paramStore){
        ...
        public boolean chainAfterHandler(){
...
//            }
            ...
            if(random==1){
                winCount++;
                System.out.println(Thread.currentThread().getName()+" win "+winCount+"!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
                return true;
            }
            return false;
        }
