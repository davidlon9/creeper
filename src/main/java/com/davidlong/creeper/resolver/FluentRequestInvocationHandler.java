...
import com.davidlong.creeper.exception.UnsupportedFluentReturnTypeException;
...
public class FluentRequestInvocationHandler implements InvocationHandler{
    ...
    private static final Class<com.davidlong.creeper.annotation.Parameter> PARAMETER_ANNO_CLASS = com.davidlong.creeper.annotation.Parameter.class;
    ...
    private void addArgsParams(RequestInfo requestInfo, Method method, Object[] args) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            com.davidlong.creeper.annotation.Parameter parameterAnnotation = parameter.getAnnotation(PARAMETER_ANNO_CLASS);
