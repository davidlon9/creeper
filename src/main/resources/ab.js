(function() {
        ...
        function Ta(a, b, c, d) {
            if (!m.ie || !m.mac) {
                ...
                d && (Aa = M = null),
                M && Aa == c || (d = q.createElement("style"),
        ...
        function pb(a) {
            if (m.ie && m.win && 4 != a.readyState) {
                ...
                a.parentNode.replaceChild(Ca(a), a)
        }
        function Da(a, b, c, d) {
            ma = !0;
            Ea = d || null;
            ...
            if (0 < a)
                for (var b = 0; b < a; b++) {
                    ...
                    if (0 < m.pv[0]) {
                        var f = K(c);
                        if (f)
                            if (!ka(N[b].swfVersion) || m.wk && 312 > m.wk)
                                if (N[b].expressInstall && Fa()) {
                                    e = {};
                        ...
                        P(c, !0),
                        d && ((c = Ga(c)) && "undefined" != typeof c.SetVariable && (e.success = !0,
                            e.ref = c),
                            d(e))
                }
        }
        ...
        function C(a, b, c, d, e, f, g) {
            return A(pa(A(A(a, b & c | ~b & d), A(e, g)), f), b)
        }
        function D(a, b, c, d, e, f, g) {
            return A(pa(A(A(a, b & d | c & ~d), A(e, g)), f), b)
        }
        function A(a, b) {
        ...
        function E(a, b, c, d, e, f, g) {
            return A(pa(A(A(a, c ^ (b | ~d)), A(e, g)), f), b)
        }
        function F(a, b, c, d, e, f, g) {
            return A(pa(A(A(a, b ^ c ^ d), A(e, g)), f), b)
        }
        function aa(a) {
            for (var b = [], c = (1 << ba) - 1, d = 0; d < a.length * ba; d += ba)
                b[d >> 5] |= (a.charCodeAt(d / ba) & c) << d % 32;
            a = a.length * ba;
            b[a >> 5] |= 128 << a % 32;
            b[(a + 64 >>> 9 << 4) + 14] = a;
            a = 1732584193;
        ...
        for (var ca = Ja, sa = Math, ta = ca, R = ta.lib, yb = R.WordArray, ua = R.Hasher, R = ta.algo, db = [], eb = [], va = 2, ga = 0; 64 > ga; ) {
            var W;
            a: {
                W = va;
                for (var zb = sa.sqrt(W), La = 2; La <= zb; La++)
                    if (!(W % La)) {
                        W = !1;
                        break a
                    }
            ...
            W && (8 > ga && (db[ga] = Ya(sa.pow(va, .5))),
                eb[ga] = Ya(sa.pow(va, 1 / 3)),
                ga++);
            va++
        }
        var S = []
            ...
            _doProcessBlock: function(a, b) {
                for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], g = c[3], p = c[4], h = c[5], m = c[6], L = c[7], k = 0; 64 > k; k++) {
                    ...
                    n = L + ((p << 26 | p >>> 6) ^ (p << 21 | p >>> 11) ^ (p << 7 | p >>> 25)) + (p & h ^ ~p & m) + eb[k] + S[k];
        ...
        var Bb = ["scrAvailWidth", "scrAvailHeight"], Cb = ["scrDeviceXDPI", "scrColorDepth", "scrWidth", "scrHeight"], rb = 0, Db = ["sessionStorage", "localStorage", "indexedDb", "openDatabase"], X, J = r, q = u, O = h, gb = !1, oa = [function() {
            if (gb) {
        ...
        ], N = [], la = [], T = [], Y, na, Ea, Va, Q = !1, ma = !1, M, Aa, Sa = !0, m, Eb = "undefined" != typeof q.getElementById && "undefined" != typeof q.getElementsByTagName && "undefined" != typeof q.createElement, wa = O.userAgent.toLowerCase(), xa = O.platform.toLowerCase(), Fb = xa ? /win/.test(xa) : /win/.test(wa), Gb = xa ? /mac/.test(xa) : /mac/.test(wa), Hb = /webkit/.test(wa) ? parseFloat(wa.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, Ma = !+"\x0B1", ha = [0, 0, 0], I = null;
        if ("undefined" != typeof O.plugins && "object" == typeof O.plugins["Shockwave Flash"])
            !(I = O.plugins["Shockwave Flash"].description) || "undefined" != typeof O.mimeTypes && O.mimeTypes["application/x-shockwave-flash"] && !O.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (gb = !0,
                Ma = !1,
        ...
        X = {
                ...
                if (b) {
                    ...
                    for (var b = b.split("\x26"), c = 0; c < b.length; c++)
                        if (b[c].substring(0, b[c].indexOf("\x3d")) == a)
                            return Ra(b[c].substring(b[c].indexOf("\x3d") + 1))
                }
                return ""
            },
            expressInstallCallback: function() {
                if (ma) {
                    ...
                    a && Y && (a.parentNode.replaceChild(Y, a),
                    na && (P(na, !0),
                    m.ie && m.win && (Y.style.display = "block")),
                    Ea && Ea(Va));
                    ma = !1
                }
            },
        ...
        Z.prototype = {
            ...
            jsFontsKey: function(a, b) {
                ...
                return H(function() {
                    ...
                    for (var f = f.concat(c.options.userDefinedFonts), g = u.getElementsByTagName("body")[0], p = u.createElement("div"), h = u.createElement("div"), m = {}, l = {}, k = [], n = 0, q = e.length; n < q; n++) {
                        var r = d();
        ...
        try {
            ...
            t.evercookie = t.Evercookie = function(a) {
                ...
                this._evercookie = function(a, c, d, B, h) {
                    ...
                    if (void 0 !== d)
                        ("undefined" === typeof ia || "undefined" === typeof ya) && B++ < g && H(function() {
                        ...
                        ia = void 0;
                        k._ec.slData = k.getFromStr(a, ya);
                        ya = void 0;
                ...
                var n = this.waitForSwf = function(a) {
                        void 0 === a ? a = 0 : a++;
                        a < g && "undefined" === typeof jb && H(function() {
                            n(a)
                        }, 300)
                    }
                ;
        ...
        ja.prototype = {
            ...
            getMimeTypes: function() {
                for (var a = h.mimeTypes, b = "", c = 0; c < a.length; c++)
                    b += a[c].type + "#";
                return new l("mimeTypes",aa(b.substr(0, b.length - 1)))
            },
            ...
            getJsFonts: function(a) {
                return new l("jsFonts",aa(a.replace(RegExp(",", "gm"), "#")))
            },
                    ...
                    c.getDfpMoreInfo(function() {
                        if (!(9E5 < G("RAIL_EXPIRATION") - (new Date).getTime() & null != G("RAIL_DEVICEID") & void 0 != G("RAIL_DEVICEID") & !c.NeedUpdate())) {
                            for (var a = "", e = "", h = c.getpackStr(b), m = [], q = [], t = [], k = [], n = 0; n < h.length; n++)
                                "new" != h[n].value
                                && -1 == Ib.indexOf(h[n].key)
                                && (-1 != Db.indexOf(h[n].key) ? q.push(h[n])
                                    : -1 != Bb.indexOf(h[n].key) ? t.push(h[n]) : -1 != Cb.indexOf(h[n].key) ? k.push(h[n]) : m.push(h[n]));
                            h = "";
                            ...
                            $a.getJSON("https://kyfw.12306.cn/otn/HttpZF/logdevice" + ("?algID\x3dLV8VaeMQEV\x26hashCode\x3d" + e + a), null, function(a) {
                                var b = JSON.parse(a);
            ...
            getTouchSupport: function(a) {
                return new l("touchSupport",aa(a.replace(RegExp(",", "gm"), "#")))
            },
            ...
            getPlugins: function(a) {
                if ("IE" == this.checkBroswer())
                    return new l("plugins",aa(a.replace(RegExp(",", "gm"), "#")));
                a = h.plugins;
                var b = "";
                for (i = 0; i < a.length; i++)
                    b += a[i].name.toString() + "#";
                return new l("plugins",aa(b))
            },
